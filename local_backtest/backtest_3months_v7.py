...
CFG = {
    ...
    "TP_ATR_MULT": 6.0,         # Config B
    "TP_ATR_MULT_TREND": 9.0,
    "TP_PARTIAL_MULT": 3.0,     # Config B
    "SL_ATR_MULT": 3.0,
    "BE_ATR_MULT": 2.7,
    "BE_BUFFER_POINTS": 50,
    "TRAIL_ATR_MULT": 0.0,
...
def print_results(closed, final_balance, initial_balance, peak_balance, max_dd_pct):
    ...
    print("\n" + "=" * 60)
    print("  6-MONTH 15-MIN BACKTEST (v8.0)")
    print("=" * 60)
    print(f"  Period:          2026-01-24 -> 2026-07-24 (6 months)")
